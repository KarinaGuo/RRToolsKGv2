...
read_dart_onerow_xls <- function(basedir,species,dataset, misschar="-", altcount=TRUE, seq2fa=FALSE, fnum=2) {

                                                 
   datafile  <- paste(basedir,species,"/Report_",dataset,".xlsx",sep="")
